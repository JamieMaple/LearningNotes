...
function isPrimitive(v) {
  return typeof v === 'string' || typeof v === 'number' || typeof v === 'undefined' || typeof v === 'null' || typeof v === 'boolean' || _typeof(v) === 'symbol';
}
...
function _render(vnode) {
  ...
  Array.isArray(vnode.children) && vnode.children.forEach(function (child) {
...
var title = _react.default.createElement("h1", null, "Hello World");
...
function (_React$Component) {
  ...
  _createClass(Counter, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("h3", null, "Counter: ", this.state.count), _react.default.createElement("button", {
...
(0, _react.render)(_react.default.createElement(App, {
  name: "Maple"
}), document.querySelector('#root'));
},{"./react":"react.js"}],"../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
